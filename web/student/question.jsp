    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <jsp:include page="header-content.jsp"></jsp:include>
            <div class="container-fluid">
                ...
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add">Add Question</button>
                                    ...
                                    <tbody>
                                        <c:forEach var="q" items="${questions}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>
                                                    <c:if test="${q.status eq 'Processing'}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="gradeModalLabel">Update Question</h5>
                                                    ...
                                                    <form name="updateForm${q.id}" id="updateForm${q.id}" action="question" method="POST" onsubmit="return validateUpdateForm(${q.id})">
                                                        <div class="modal-body">
                                                            ...
                                                            <input class="form-control" name="title" value="${q.title}" type="text" placeholder="Enter question title">
                                                            <span id="updateTitleError${q.id}" style="color: red; font-size: smaller"></span>

                                                            <hr>
                                                            <label class="form-text">Send to</label>
                                                            <input class="form-control" type="hidden" name="receiver" value="${lecturer.accountLecturer.id}">
                                                            <input class="form-control" type="text" readonly="" disabled="" value="${lecturer.fullName}">
                                                            <hr>
                                                            <label class="form-text">Content</label>
                                                            <textarea class="form-control" name="content" type="text" placeholder="Enter question content" rows="6">${q.content}</textarea>
...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form name="questionForm" id="questionForm" action="question" method="POST" onsubmit="return validateForm()">
                <div class="modal-body">
                    <label class="form-text">Title</label>
                    <input class="form-control" name="title" type="text" placeholder="Enter question title">
                    ...
                    <hr>
                    <label class="form-text">Content</label>
                    <textarea class="form-control" name="content" type="text" placeholder="Enter question content" rows="6"></textarea>
...
<script>
    function validateForm() {
        ...
        // Get form elements
        var title = document.forms["questionForm"]["title"].value;
        ...
        // Validate content
        if (content === "") {
            document.getElementById("descriptionError").innerText = "Content is required.";
            isValid = false;
        }
