...
@WebServlet(name = "LecturerEventServlet", urlPatterns = {"/lecturer/events"})
public class LecturerEventServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a != null && a.getRoleAccount().getRole_id() == 3) {
            try {
                ...
                request.getRequestDispatcher("lecturer-events.jsp").forward(request, response);
            } catch (Exception ex) {
